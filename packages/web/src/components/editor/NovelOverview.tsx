...
import { BookOpen, Trash2, FileText, PenLine, Wand2, Clock } from 'lucide-react';
import { useNovelStore } from '@/stores/novel-store';
import { useToast } from '@/components/common/Toast';

/**
 * 作品概览页：选中作品后中央编辑区显示（无打开章节时）。
 * 承载作品元信息 + 删除入口（删除从列表项移到这里）。
 * 简介编辑已迁至中央 AI 起稿窗口，本页仅只读展示。
 */
                ...
                <div className="rounded-xl bg-white/4 border border-white/8 p-4 mb-6">
                    <p className="text-sm text-neutral-300 leading-relaxed whitespace-pre-wrap">
                        {currentNovel.description?.trim()
                            ...
                            : '暂无简介。可点击右下角「AI 起稿」由 AI 生成，或在起稿窗口手动填写。'}
                    </p>
                </div>
